...
impl From<&OrientConstraint> for OrientConstraintData {
    fn from(o: &OrientConstraint) -> Self {
        Self {
            ...
            parent_bone_name: o.parent_bone_name.to_string_lossy(),
            driver_bone_name: o.driver_bone_name.to_string_lossy(),
            unk_type: o.unk_type,
...
impl From<&OrientConstraintData> for OrientConstraint {
    fn from(o: &OrientConstraintData) -> Self {
        Self {
            ...
            parent_bone_name: o.parent_bone_name.as_str().into(),
            driver_bone_name: o.driver_bone_name.as_str().into(),
            unk_type: o.unk_type,
            constraint_axes: o.constraint_axes,
            quat1: o.quat1,
            quat2: o.quat2,
        ...
        let ssbh = Hlpb::V11 {
            ...
            orient_constraints: vec![
                OrientConstraint {
                    ...
                    parent_bone_name: "HandL".into(),
                    driver_bone_name: "H_WristL".into(),
                    unk_type: 2,
                ...
                OrientConstraint {
                    ...
                    parent_bone_name: "HandR".into(),
                    driver_bone_name: "H_WristR".into(),
                    unk_type: 2,
                    constraint_axes: Vector3::new(0.5, 0.5, 0.5),
                    quat1: Vector4::new(0.0, 0.0, 0.0, 1.0),
                    quat2: Vector4::new(0.0, 0.0, 0.0, 1.0),
        ...
        let data = HlpbData {
            ...
            orient_constraints: vec![
                OrientConstraintData {
                    ...
                    parent_bone_name: "HandL".to_string(),
                    driver_bone_name: "H_WristL".to_string(),
                    unk_type: 2,
                    constraint_axes: Vector3::new(0.5, 0.5, 0.5),
                    quat1: Vector4::new(0.0, 0.0, 0.0, 1.0),
                    quat2: Vector4::new(0.0, 0.0, 0.0, 1.0),
                ...
                OrientConstraintData {
                    ...
                    parent_bone_name: "HandR".to_string(),
                    driver_bone_name: "H_WristR".to_string(),
                    unk_type: 2,
                    constraint_axes: Vector3::new(0.5, 0.5, 0.5),
                    quat1: Vector4::new(0.0, 0.0, 0.0, 1.0),
                    quat2: Vector4::new(0.0, 0.0, 0.0, 1.0),
